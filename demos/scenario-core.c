...
ragdoll ragdoll_create(bnd_world *world, bnd_v3 position) {
  ...
  bnd_set_position(world, torso, Vector3Add(position, (Vector3){ 0, 4.1, 0}));

  bnd_body_handle pelvis = bnd_add_capsule_dynamic(world, 20, 0.25, 0.5).value;
  bnd_set_position(world, pelvis, Vector3Add(position, (Vector3){ 0, 3.1, 0}));

  bnd_body_handle left_upper_leg = bnd_add_capsule_dynamic(world, 10, 0.2, 0.8).value;
  bnd_set_position(world, left_upper_leg, Vector3Add(position, (Vector3){ 0.23, 2, -0.2}));
  ...
  bnd_set_position(world, left_lower_leg, Vector3Add(position,(Vector3) {0.23, 0.9, -0.2}));
  ...
  bnd_set_position(world, right_upper_leg, bnd_v3_add(position, (Vector3){-0.23, 2, 0}));

  bnd_body_handle right_lower_leg = bnd_add_capsule_dynamic(world, 10, 0.2, 0.8).value;
  bnd_set_position(world, right_lower_leg, bnd_v3_add(position, (Vector3){-0.23, 0.7, 0}));
